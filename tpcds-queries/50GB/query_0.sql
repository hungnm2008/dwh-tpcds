...
select top 100 i_item_id
 ...
 and d_date between cast('1998-02-07' as date) 
         and (dateadd(day,30,cast('1998-02-07' as date)))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (dateadd(day,-30,cast ('2002-06-12' as date)))
                        and (dateadd(day,-30,cast ('2002-06-12' as date)))
...
and d_date between '2002-01-27' and
        (dateadd(day,90,cast('2002-01-27' as date)))
...
select top 100 i_item_id
 ...
 and d_date between cast('2002-04-13' as date) and (dateadd(day,60,cast('2002-04-13' as date)))
...
select top 100 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('2001-04-26' as date)))
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-14' as date) and (dateadd(day,60,cast('2002-03-14' as date)))
...
and d_date between '1998-02-26' and 
        (dateadd(day,90,cast('1998-02-26' as date)))
...
where 
	...
	and d_date between cast('1999-05-23' as date) 
				and (dateadd(day,30,cast('1999-05-23' as date)))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
