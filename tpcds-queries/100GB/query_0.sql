...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (dateadd(day,-30,cast ('2002-02-27' as date)))
                        and (dateadd(day,-30,cast ('2002-02-27' as date)))
...
and d_date between '1999-01-07' and
        (dateadd(day,90,cast('1999-01-07' as date)))
...
select top 100 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (dateadd(day, -30, cast ('2001-04-02' as date)))
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-07-09' as date) and (dateadd(day,60,cast('1999-07-09' as date)))
...
and d_date between '2002-02-26' and 
        (dateadd(day,90,cast('2002-02-26' as date)))
